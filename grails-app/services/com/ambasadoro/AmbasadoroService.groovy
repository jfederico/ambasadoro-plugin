...
class AmbasadoroService {
	...
	def getCartridgeXML(ambasadoro, engineClass) {
		...
		'    <blti:launch_url>' + retrieveEndpoint() + '/lti/tool/' + ambasadoro.getId() + '</blti:launch_url>' +
		'    <blti:secure_launch_url>' + retrieveEndpoint('https') + '/lti/tool/' + ambasadoro.getId() + '</blti:secure_launch_url>' +
		'    <blti:icon>' + retrieveEndpoint() + '/images/' + ambasadoro.getId() + '/favicon.ico</blti:icon>' +
		'    <blti:secure_icon>' + retrieveEndpoint('https') + '/images/' + ambasadoro.getId() + '/favicon.ico</blti:secure_icon>' +
		'    <blti:vendor>' +
